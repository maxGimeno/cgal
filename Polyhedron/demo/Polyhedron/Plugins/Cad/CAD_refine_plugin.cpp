    ...
    protected Polyhedron_demo_plugin_interface
{
  ...
  Q_PLUGIN_METADATA(IID "com.geometryfactory.PolyhedronDemo.PluginInterface/1.0" FILE "cad_refine_plugin.json")
...
void Polyhedron_demo_CAD_refine_plugin::refine()
{
  ...
  if(!c3t3_cad_item)
    return;
  C3t3_cad& c3t3 = c3t3_cad_item->c3t3();
  const Mesh_domain_cad& mesh_domain = c3t3_cad_item->meshDomain();
