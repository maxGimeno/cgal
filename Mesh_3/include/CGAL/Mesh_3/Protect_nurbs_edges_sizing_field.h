...
class Protect_nurbs_edges_sizing_field
{
  typedef Protect_nurbs_edges_sizing_field          Self;
...
public:
  Protect_nurbs_edges_sizing_field(C3T3& c3t3,
...
Protect_nurbs_edges_sizing_field<C3T3, MD, Sf>::
Protect_nurbs_edges_sizing_field(C3T3& c3t3, const MD& domain,
...
template <typename C3T3, typename MD, typename Sf>
typename Protect_nurbs_edges_sizing_field<C3T3, MD, Sf>::Vertex_handle
Protect_nurbs_edges_sizing_field<C3T3, MD, Sf>::
...
template <typename C3T3, typename MD, typename Sf>
template <typename ErasedVeOutIt>
std::pair<typename Protect_nurbs_edges_sizing_field<C3T3, MD, Sf>::Vertex_handle,
	  ErasedVeOutIt>
Protect_nurbs_edges_sizing_field<C3T3, MD, Sf>::
...
insert_balls_on_edges()
{
       ...
       end = input_features.end() ; fit != end ; ++fit )
  {
    ...
    if ( ! is_treated(curve_index) )
    {
      ...
      Point_3 q_point(eval_point[0], eval_point[1], eval_point[2]);
...
namespace details {
  ...
  // Functor used by Protect_nurbs_edges_sizing_field::check_and_repopulate_edges, below
